    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20">
        <div className="mb-16 text-center">
          <h2 className="text-4xl font-bold text-blue-900">Request Leave in Seconds</h2>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-[2rem] bg-white p-10 shadow-xl border border-blue-50">
            <div className="mb-8 flex items-center gap-5">
              ...
              <div>
                <h3 className="text-2xl font-bold text-blue-900">Quick Request</h3>
            ...
            <div className="space-y-4">
              {['Select leave type & dates', 'Add reason & attachments', 'Submit for approval'].map((text, i) => (
                <div key={i} className="flex items-center gap-4 rounded-2xl bg-blue-50 p-4 text-blue-700 font-medium">
          ...
          <div className="rounded-[2rem] bg-white p-10 shadow-xl border border-blue-50">
            <div className="mb-8 flex items-center gap-5">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-900 text-white shadow-lg shadow-blue-200">
                <i className="fas fa-coffee fa-lg text-orange-400"></i>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-blue-900">Live Balance Tracking</h3>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-4 text-center">
          ...
          <h2 className="mt-6 text-4xl font-bold text-blue-900">Approve with Confidence</h2>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            <div className="rounded-3xl border border-blue-50 bg-white p-8 shadow-lg">
              ...
              <h3 className="mb-6 text-left text-xl font-bold text-blue-900">Pending Requests</h3>
              <div className="space-y-3">
                <div className="rounded-xl bg-orange-50 p-4 text-left border border-orange-100">
                  <div className="flex justify-between font-bold text-blue-900"><span>Sarah Chen</span><span className="text-orange-600">New</span></div>
            ...
            <div className="rounded-3xl border border-blue-50 bg-white p-8 shadow-lg">
              ...
              <h3 className="mb-6 text-left text-xl font-bold text-blue-900">Smart Workflows</h3>
            ...
            <div className="rounded-3xl border border-blue-50 bg-white p-8 shadow-lg">
              <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-900 text-orange-400">
                <i className="fas fa-chart-line"></i>
              </div>
              <h3 className="mb-6 text-left text-xl font-bold text-blue-900">Team Overview</h3>
      ...
      <section className="bg-slate-50 py-24 border-t border-blue-100">
        <div className="mx-auto max-w-7xl px-4 text-center">
          <span className="rounded-full bg-blue-900 px-6 py-1.5 text-sm font-semibold text-orange-400">HR Administration</span>
          <h2 className="mt-6 text-4xl font-bold text-blue-900">Full Policy Control</h2>
          ...
          <div className="mt-16 grid gap-6 lg:grid-cols-4 text-left">
            {['Policy Engine', 'Auto Accrual', 'Reports', 'Audit Trail'].map((title, i) => (
              <div key={i} className="rounded-3xl bg-white p-8 shadow-md border-b-4 border-blue-900">
